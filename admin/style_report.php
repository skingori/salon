        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    <strong>STYLES REPORT</strong><br>
                </address>
                <!-- FOR USER PROFILE -->
            </div>
            <!-- /.col -->
                ...
                <table class="table table-striped table-bordered" style="font-family: 'Palatino','serif',Consolas;font-size: small">
                    ...
                    while ($row2 = mysqli_fetch_assoc($rs_result)) {
                        ...
                        <tr>
                            ...
                            <td><textarea class="test"><?php echo $row2["Style_Name"]; ?></textarea></td>
                            <td><textarea class="test"><?php echo $row2["Style_Charges"]; ?></textarea></td>
                            <td><textarea class="test"><?php echo $row2["Style_Description"]; ?></textarea></td>
                        </tr>
                        <?php
                    };
                    ?>
