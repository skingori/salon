        ...
        <div class="profile_details_left"><!--notifications of menu start -->
            <ul class="nofitications-dropdown">
                <li class="dropdown head-dpdn">
                    ...
                    $result = mysqli_query($con,"SELECT COUNT(Booking_Id) FROM Booking_Table WHERE Booking_customer_id='$myid' ORDER BY Booking_Id DESC  ");
                ...
                <li class="dropdown profile_details_drop">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <div class="profile_img">
                            <span class="prfil-img"><img style="width: 50px;" class="img-thumbnail" src="../images/user-admin.png" alt=""> </span>
                            <div class="user-name">
                                <p>Logged in as:</p>
